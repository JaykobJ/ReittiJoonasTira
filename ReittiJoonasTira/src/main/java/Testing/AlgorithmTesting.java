...
public class AlgorithmTesting {
    ...
    {
        astarTestMethod("testMap1.map");
        astarTestMethod("testMap2.map");
        astarTestMethod("testMap3.map");
        astarTestMethod("testMap4.map");
        astarTestMethod("testMap5.map");
        astarTestMethod("testMap6.map");
        astarTestMethod("testMap7.map");
        astarTestMethod("testMap8.map");
        dijkstraTestMethod("testMap1.map");
        dijkstraTestMethod("testMap2.map");
        dijkstraTestMethod("testMap3.map");
        dijkstraTestMethod("testMap4.map");
        dijkstraTestMethod("testMap5.map");
        dijkstraTestMethod("testMap6.map");
        dijkstraTestMethod("testMap7.map");
        dijkstraTestMethod("testMap8.map");
    }
